...
import { Check, Copy, Loader2, Mail, RotateCcw, Search, Trash2, X } from "lucide-react";
    ...
    <div className="space-y-6 max-w-3xl">
            ...
            {filtered.map((entry) => (
              <div key={entry.id} className="flex items-center gap-3 py-3">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-2xs text-text-muted mt-0.5">Inscrito em {formatDate(entry.created_at)}</p>
                </div>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  <a
                    href={`mailto:${entry.email}?subject=${encodeURIComponent("Seu acesso ao Meiro está liberado")}`}
      ...
      <Card>
        ...
        <p className="text-sm text-text-muted leading-relaxed">
          Aprovar aqui marca a pessoa como liberada, mas não cria a conta automaticamente (o app não usa uma chave
          de administrador no navegador, por segurança). Depois de aprovar, clique no ícone de e-mail para avisar a
          pessoa e ela poderá criar a conta normalmente na tela de login com o mesmo e-mail.
        </p>
      </Card>
    </div>
  );
